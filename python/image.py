...
#		print('x = ', x, 'y = ', y)
		...
		COLOR_R1 = showArray[x][y+0][0]
		COLOR_G1 = showArray[x][y+0][1]
		COLOR_B1 = showArray[x][y+0][2]
		COLOR_R2 = showArray[x][y+1][0]
		COLOR_G2 = showArray[x][y+1][1]
		COLOR_B2 = showArray[x][y+1][2]
		COLOR_R3 = showArray[x][y+2][0]
		COLOR_G3 = showArray[x][y+2][1]
		COLOR_B3 = showArray[x][y+2][2]
		COLOR_R4 = showArray[x][y+3][0]
		COLOR_G4 = showArray[x][y+3][1]
		COLOR_B4 = showArray[x][y+3][2]
		COLOR_R5 = showArray[x][y+4][0]
		COLOR_G5 = showArray[x][y+4][1]
		COLOR_B5 = showArray[x][y+4][2]
		COLOR_R6 = showArray[x][y+5][0]
		COLOR_G6 = showArray[x][y+5][1]
		COLOR_B6 = showArray[x][y+5][2]
